  ...
  return (
    <main className="min-h-screen bg-[#0C0A08]">
      <section className="relative pt-32 pb-16 md:pb-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#D4A574]/[0.02] to-transparent pointer-events-none" />
      ...
      <div className="sticky top-[72px] md:top-[80px] z-20 bg-[#0C0A08]/80 backdrop-blur-2xl border-b border-white/[0.04]">
                ...
                {filtered.map((dish, i) => (
                  ...
                  >
                    <div
                      ...
                      className="group relative bg-[#0C0A08] overflow-hidden cursor-pointer hover:bg-white/[0.02] transition-colors duration-500 h-full"
                    >
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {dish.tags.slice(0, 2).map((tag) => (
                            <span key={tag} className="text-[8px] tracking-[0.2em] uppercase px-2 py-0.5 border border-[#D4A574]/10 text-[#D4A574]/50">
                              {tag}
                            </span>
                          ))}
                        </div>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <span className="text-xl text-[#D4A574]">{formatPrice(selectedItem.price)}</span>
                </div>
                <p className="text-sm text-white/40 leading-relaxed">{selectedItem.description}</p>
                <div className="flex flex-wrap gap-2">
                  {selectedItem.tags.map((tag) => (
                    <span key={tag} className="text-[10px] px-3 py-1 border border-[#D4A574]/10 text-[#D4A574]/60 uppercase tracking-wider">
                      {tag}
                    </span>
                  ))}
                </div>
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/[0.04]">
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      <Star size={14} className="text-[#D4A574] fill-[#D4A574]" />
