      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <AnimatedSection>
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 w-48 md:w-64 h-48 md:h-64 bg-[#D4A574]/5 border border-[#D4A574]/10 p-6 md:p-8 hidden md:flex flex-col justify-center">
                <p className="font-[family-name:var(--font-display)] text-4xl text-[#D4A574]">2009</p>
          ...
          <AnimatedSection delay={0.15}>
            ...
            <div className="mt-8 w-12 h-[1px] bg-[#D4A574]/40" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/[0.04] mt-24">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="bg-[#0C0A08] py-10 md:py-14 text-center"
            >
              <p className="font-[family-name:var(--font-display)] text-3xl md:text-4xl text-[#D4A574]">
                {stat.number}
              </p>
